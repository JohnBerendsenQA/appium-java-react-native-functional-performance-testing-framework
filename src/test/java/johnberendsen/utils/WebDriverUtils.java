...
public class WebDriverUtils {
    ...
    @Value("${udid: udid}")
    private String udid;
    @Value("${app.activity:com.johnberendsen.MainActivity}")
    private String appActivity;
    @Value("${app.package:com.johnberendsen}")
    ...
    private DesiredCapabilities getDesiredCapabilities() {
        ...
        capabilities.setCapability("appWaitActivity", "com.johnberendsen.MainActivity");
        if (cloud) {

package johnberendsen.frontend.screenobjects;

import io.appium.java_client.AppiumDriver;
import io.appium.java_client.MobileElement;
import io.appium.java_client.android.AndroidKeyCode;
import johnberendsen.utils.ScreenObjectUtils.BaseScreenObject;
...
public class SearchBarObject extends BaseScreenObject {
    ...
    public WebElement getSearchField() {
        String iosClassChain = "**/XCUIElementTypeOther[`name = \"\uE8B6 Search johnberendsen\"`]";
        String androidXpath  = "//android.widget.EditText[contains(@text, 'Search johnberendsen')]";
